...
const SingleProductPage = async ({
  ...
  return (
    <>
    <Cointainer className="flex flex-col md:flex-row gap-10 py-10">
      {product?.images && (
      ...
      <div className="w-full md:w-1/2 flex flex-col gap-5">
        <div className="space-y-1">
          ...
          <p className=" text-sm text-gray-600 travkcking">
            {product?.description}
          </p>
        ...
        <div className="space-y-2 border-t border-b border-gray-200 py-5">
          ...
          />
          <p
            className={`px-4 py-1.5 text-sm text-center inline-block font-semibold rounded-lg ${product?.stock === 0 ? "bg-red-100 text-red-600" : "bg-green-100 text-green-600"}`}
          >
